Garnish.$doc.ready(function () {
  Craft.elementIndex.statusMenu.$container.addClass('qarr-menu');
  console.log(Craft.elementIndex.statusMenu); //     // let wave1 = $('#feel-the-wave').wavify({
  //     //     height: 20,
  //     //     bones: 3,
  //     //     amplitude: 40,
  //     //     color: '#E9EFF4',
  ...
  //     // });
  //
  //     let qarrInputFields = document.querySelectorAll('.custom-field');
  ...
  //                 let count = Craft.elementIndex.view.elementSelect.$selectedItems.length;
  //
  //                 let $countContainer = $('<div class="elements-selected-count">');
  //                 let $countHtml = $('<span>'+ count +' '+ Craft.t("qarr", "items selected") +'</span>');
  //
