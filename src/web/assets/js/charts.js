...
var QarrLineChart = void 0,
    QarrPieChart = void 0,
    QarrDonutChart = void 0;
...
QarrLineChart = Garnish.Base.extend({
    ...
    createChartExplorer: function createChartExplorer() {
        ...
        var $totalLabel = $('<div class="total-label"><p>' + Craft.t('qarr', 'Total Submissions') + '</p></div>').appendTo($total);
...
QarrPieChart = Garnish.Base.extend({
    ...
    addSlices: function addSlices(data) {
        ...
        data.forEach(function (slice) {
            var _getCoordinatesForPer = _this._getCoordinatesForPercent(_this.cumulativePercent),
            ...
            var _getCoordinatesForPer3 = _this._getCoordinatesForPercent(_this.cumulativePercent),
