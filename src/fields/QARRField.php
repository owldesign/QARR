...
namespace owldesign\qarr\fields;

use owldesign\qarr\QARR;
use owldesign\qarr\assetbundles\qarrfieldfield\QARRFieldFieldAsset;
...
class QARRField extends Field
{
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'qarr/_components/fields/QARRField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(QARRFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').QARRQARRField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'qarr/_components/fields/QARRField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
